...
def train_transformer_with_confidence(df1, df2, df3, true_labels_df3, timesteps=16):
    """
    Train a Transformer model using labeled data only.
    """
...
model, history, y_test_labeled, yhat_classes, yhat_probs, testdf1, testdf2, testdf3 = train_transformer_with_confidence(df_scaled, d2_scaled, sams_scaled, true_labels_df3)
